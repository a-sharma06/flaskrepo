...
def about():
    ...
    p = figure(tools="pan,wheel_zoom,box_zoom,reset", title='Quandl WIKI EOD Stock Price - 2017 '+ features[5], x_axis_label='Time', y_axis_label='Price', x_axis_type="datetime")
